    ...
    grunt.initConfig({
        ...
        shell: {
            ...
            initializeCordovaPlugins: {
                command: 'cordova plugin add org.apache.cordova.file https://github.com/apache/cordova-plugin-whitelist org.apache.cordova.file-transfer https://github.com/Telerik-Verified-Plugins/PushNotification',
                options: {
                    execOptions: {
                        cwd: everliveCordovaPath
                    }
